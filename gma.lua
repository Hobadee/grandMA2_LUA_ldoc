...
---Sleeps the LUA script for number of seconds
--
--Functionally itendical to gma_sleep???
--@tparam number sleep_seconds Number of seconds to sleep for.
--@usage gma.sleep(5);
--@usage gma.sleep(0.1);
...
--@treturn string Assumming Build Date of GMA2 software?
--@usage
--  gma.build_date();
--  "Aug 25 2015"
...
--@treturn string Assumming Build Time of GMA2 software?
--@usage
--  gma.build_time();
--  "18:18:44"
...
--@tparam string filename Filename to export as???
